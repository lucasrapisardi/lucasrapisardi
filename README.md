...
**AI Automation Engineer & Systems Administrator**
...
I build production-grade AI-powered systems and automation pipelines. My focus is turning manual, repetitive workflows into intelligent, observable, and scalable processes — from infrastructure management at scale to multi-tenant SaaS platforms built from scratch.

---

## 🚀 ProducSync / Trinis AI — Founder & Lead Engineer

> Multi-tenant SaaS that orchestrates an end-to-end AI pipeline for automated product synchronization between vendor sources and Shopify stores.

| | |
|---|---|
| **Pipeline** | Scrape → Enrich (GPT-4o) → Image Generation → Shopify Sync |
| **Architecture** | Multi-tenant with row-level isolation · Fernet-encrypted token storage |
| **Billing** | Stripe webhooks · subscription lifecycle management |
| **Observability** | Live job logging · timestamped progress tracking · structured error summaries |
...
**ITSM**
`ServiceNow` `ITIL` `Incident / Change / Problem` `CMDB` `CAB`
